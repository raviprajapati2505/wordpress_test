 ...
 * Description:       A custom plugin which will create one page with by default shortcode placed as content on activation and delete automatically that page when deactivated
 * Version:           1.0.0
