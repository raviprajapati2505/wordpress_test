...
/* Restric admin to access pixlogix page edit  */
...
function restrict_admin() {
	...
	if (strpos($page[1], 'action=edit') !== false) {
		$filter_page_id = str_replace('post=', '', $page[1]);
		$filter_page_id = str_replace('&action=edit', '', $filter_page_id);
		if(get_page($filter_page_id)->post_name == 'pixlogix_test' && in_array("administrator", $roles)){
...
function pixlogix_show_posts_loop( $attrs ) {
...
add_shortcode( 'pixlogix_show_posts', 'pixlogix_show_posts_loop' );